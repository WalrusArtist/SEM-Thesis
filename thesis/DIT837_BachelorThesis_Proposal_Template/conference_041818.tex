...
\subsection{Research Question 1: Prevalent automation practices and patterns observed within GitHub repositories, particularly concerning the adoption and utilization of GHA.}

\subsubsection{Research Method: Case Study}
...
\subsection{Research Question 2: Distribution pattern and factors influencing reliance on locally maintained actions versus marketplace actions.}

\subsubsection{Research Method: Survey}
...
\subsection{Research Question 3: Primary challenges and issues encountered during the implementation and usage of GHA, and comparison with established software library ecosystems.}

\subsubsection{Research Method: Data Mining and Interview}
