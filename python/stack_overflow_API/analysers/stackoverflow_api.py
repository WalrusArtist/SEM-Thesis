...
post_data = {}
with open('../data/github-actions-stack.json', 'r') as file:
...
security_vulnerabilities_terms = ["security","Security flaws", "Security risk", "Vulnerabilities", "Exploit", "Security loopholes", "Attack vectors"]
